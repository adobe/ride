 ...
 * 
 */
public class UnexpectedModelDefinitionException extends ServiceException {
   ...
   */
  public UnexpectedModelDefinitionException(JSONObject obj) {
    super("Encountered unexpected model definition when loading model: " + obj.toString());
